...
class UserApi:
    ...
    def user_destroy(
        self,
        id: Annotated[StrictInt, Field(description="User entry ID")],
        ...
        _param = self._user_destroy_serialize(
            id=id,
    ...
    @validate_call
    def user_destroy_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="User entry ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_destroy_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="User entry ID")],
        _request_timeout: Union[
            None,
    ...
    def user_index(
        ...
        _param = self._user_index_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def user_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserIndex200Response]:
        """User@index
    ...
    def user_show(
        ...
        _param = self._user_show_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def user_show_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserShow200Response]:
        """User@show
    ...
    def user_update(
        self,
        id: Annotated[StrictInt, Field(description="User ID")],
        user_update_request: Annotated[UserUpdateRequest, Field(description="User definition")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: User ID (required)
        :type id: int
        :param user_update_request: User definition (required)
    ...
    def user_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserUpdate200Response]:
        """User@update
