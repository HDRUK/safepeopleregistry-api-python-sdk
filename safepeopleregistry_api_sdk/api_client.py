...
from safepeopleregistry_api_sdk.configuration import Configuration
from safepeopleregistry_api_sdk.api_response import ApiResponse, T as ApiResponseT
import safepeopleregistry_api_sdk.models
from safepeopleregistry_api_sdk import rest
from safepeopleregistry_api_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.0-test2/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(safepeopleregistry_api_sdk.models, klass)
