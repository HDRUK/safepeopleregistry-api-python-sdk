...
class AccreditationUpdateByRegistryId200Response(BaseModel):
    """
    ...
    data: Optional[Accreditation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": Accreditation.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
