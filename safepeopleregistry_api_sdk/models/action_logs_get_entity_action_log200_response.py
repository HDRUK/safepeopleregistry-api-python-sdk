...
class ActionLogsGetEntityActionLog200Response(BaseModel):
    """
    ActionLogsGetEntityActionLog200Response
    """ # noqa: E501
    data: Optional[List[ActionLog]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ActionLog.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
