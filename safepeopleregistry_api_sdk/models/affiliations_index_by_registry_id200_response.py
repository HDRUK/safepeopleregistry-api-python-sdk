...
class AffiliationsIndexByRegistryId200Response(BaseModel):
    """
    AffiliationsIndexByRegistryId200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[List[Affiliation]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Affiliation.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
