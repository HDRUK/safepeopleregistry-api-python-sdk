...
class CustodianModelConfigGetByCustodianID200Response(BaseModel):
    """
    CustodianModelConfigGetByCustodianID200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[CustodianModelConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CustodianModelConfig.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
