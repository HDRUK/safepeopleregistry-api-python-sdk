...
class CustodianModelConfigGetEntityModels200Response(BaseModel):
    """
    ...
    data: Optional[List[CustodianModelConfigGetEntityModels200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CustodianModelConfigGetEntityModels200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
