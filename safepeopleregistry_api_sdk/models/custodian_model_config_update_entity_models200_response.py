...
class CustodianModelConfigUpdateEntityModels200Response(BaseModel):
    """
    CustodianModelConfigUpdateEntityModels200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Custodian model configs updated successfully"]})
    data: Optional[List[CustodianModelConfigUpdateEntityModelsRequestConfigsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CustodianModelConfigUpdateEntityModelsRequestConfigsInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
