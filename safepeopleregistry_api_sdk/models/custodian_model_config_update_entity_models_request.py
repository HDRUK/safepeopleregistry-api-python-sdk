...
class CustodianModelConfigUpdateEntityModelsRequest(BaseModel):
    """
    CustodianModelConfigUpdateEntityModelsRequest
    """ # noqa: E501
    configs: Optional[List[CustodianModelConfigUpdateEntityModelsRequestConfigsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [CustodianModelConfigUpdateEntityModelsRequestConfigsInner.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
