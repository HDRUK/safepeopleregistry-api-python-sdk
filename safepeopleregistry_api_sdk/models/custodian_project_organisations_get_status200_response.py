...
class CustodianProjectOrganisationsGetStatus200Response(BaseModel):
    """
    ...
    data: Optional[CustodianProjectOrganisationsGetStatus200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CustodianProjectOrganisationsGetStatus200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
