...
class CustodianProjectOrganisationsGetStatus200ResponseData(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Example Organisation"]})
    model_state: Optional[CustodianProjectOrganisationsGetStatus200ResponseDataModelState] = None
    __properties: ClassVar[List[str]] = ["id", "name", "model_state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "model_state": CustodianProjectOrganisationsGetStatus200ResponseDataModelState.from_dict(obj["model_state"]) if obj.get("model_state") is not None else None
        })
        return _obj
