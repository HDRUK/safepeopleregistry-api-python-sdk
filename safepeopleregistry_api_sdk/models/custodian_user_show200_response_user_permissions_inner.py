...
class CustodianUserShow200ResponseUserPermissionsInner(BaseModel):
    """
    CustodianUserShow200ResponseUserPermissionsInner
    """ # noqa: E501
    custodian_user_id: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [1]})
    permission_id: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [10]})
    permission: Optional[Permission] = None
    __properties: ClassVar[List[str]] = ["custodian_user_id", "permission_id", "permission"]
