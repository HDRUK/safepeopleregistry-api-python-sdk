...
class CustodiansCreateCustodianValidationChecksRequest(BaseModel):
    """
    CustodiansCreateCustodianValidationChecksRequest
    """ # noqa: E501
    name: StrictStr = Field(json_schema_extra={"examples": ["Check format"]})
    type: StrictStr = Field(json_schema_extra={"examples": ["format"]})
    description: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Ensures proper formatting of input"]})
