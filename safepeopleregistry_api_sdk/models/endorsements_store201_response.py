...
class EndorsementsStore201Response(BaseModel):
    """
    EndorsementsStore201Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["success"]})
    data: Optional[StrictInt] = Field(default=None, description="ID of the created Endorsement entry", json_schema_extra={"examples": [123]})
