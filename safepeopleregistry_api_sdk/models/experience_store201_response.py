...
class ExperienceStore201Response(BaseModel):
    """
    ExperienceStore201Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["success"]})
    data: Optional[StrictInt] = Field(default=None, description="ID of the newly created experience", json_schema_extra={"examples": [123]})
