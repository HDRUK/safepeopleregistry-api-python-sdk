...
class IdentityIndex200Response(BaseModel):
    """
    IdentityIndex200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[IdentityIndex200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": IdentityIndex200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
