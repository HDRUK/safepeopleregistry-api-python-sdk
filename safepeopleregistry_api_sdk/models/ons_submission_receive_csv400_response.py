...
class ONSSubmissionReceiveCSV400Response(BaseModel):
    """
    ONSSubmissionReceiveCSV400Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["failed"]})
    data: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["file upload failed - please contact support"]})
