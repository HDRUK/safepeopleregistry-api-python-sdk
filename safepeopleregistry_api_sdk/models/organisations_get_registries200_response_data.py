...
class OrganisationsGetRegistries200ResponseData(BaseModel):
    """
    OrganisationsGetRegistries200ResponseData
    """ # noqa: E501
    current_page: Optional[StrictInt] = None
    data: Optional[List[OrganisationsGetRegistries200ResponseDataDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [OrganisationsGetRegistries200ResponseDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
