...
class ProjectUpdateAllProjectUsersRequest(BaseModel):
    """
    ProjectUpdateAllProjectUsersRequest
    """ # noqa: E501
    users: Optional[List[ProjectUpdateAllProjectUsersRequestUsersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [ProjectUpdateAllProjectUsersRequestUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
