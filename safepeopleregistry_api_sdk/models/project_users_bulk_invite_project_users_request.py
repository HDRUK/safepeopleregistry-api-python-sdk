...
class ProjectUsersBulkInviteProjectUsersRequest(BaseModel):
    """
    ProjectUsersBulkInviteProjectUsersRequest
    """ # noqa: E501
    project_id: StrictInt = Field(alias="projectId", json_schema_extra={"examples": [1]})
    users: List[ProjectUsersBulkInviteProjectUsersRequestUsersInner]
    __properties: ClassVar[List[str]] = ["projectId", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [ProjectUsersBulkInviteProjectUsersRequestUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
