...
class QueryQuery401Response(BaseModel):
    """
    QueryQuery401Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["no known custodian matches the credentials provided"]})
