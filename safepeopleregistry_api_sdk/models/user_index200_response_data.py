...
class UserIndex200ResponseData(BaseModel):
    """
    ...
    uksa_registered: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [True]})
    is_sro: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [False]})
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "first_name", "last_name", "email", "email_verified_at", "consent_scrape", "public_opt_in", "declaration_signed", "organisation_id", "orcid_scanning", "orcid_scanning_completed_at", "location", "t_and_c_agreed", "t_and_c_agreement_date", "uksa_registered", "is_sro"]
