...
class UserShow200Response(BaseModel):
    """
    UserShow200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[UserShow200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": UserShow200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
