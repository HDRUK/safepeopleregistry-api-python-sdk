...
class UserShow200ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "first_name", "last_name", "email", "email_verified_at", "consent_scrape", "public_opt_in", "declaration_signed", "organisation_id", "orcid_scanning", "orcid_scanning_completed_at", "location", "t_and_c_agreed", "t_and_c_agreement_date", "status", "uksa_registered", "is_sro"]
