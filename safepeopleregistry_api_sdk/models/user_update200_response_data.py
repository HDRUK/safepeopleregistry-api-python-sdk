...
class UserUpdate200ResponseData(BaseModel):
    """
    ...
    orc_id: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["0000-0000-0000-0000"]})
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "first_name", "last_name", "email", "email_verified_at", "consent_scrape", "public_opt_in", "declaration_signed", "organisation_id", "orc_id", "orcid_scanning", "orcid_scanning_completed_at", "t_and_c_agreed", "t_and_c_agreement_date", "status", "uksa_registered", "is_sro"]
