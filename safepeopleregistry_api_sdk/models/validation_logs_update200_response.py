...
class ValidationLogsUpdate200Response(BaseModel):
    """
    ValidationLogsUpdate200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Action status updated successfully"]})
    data: Optional[ValidationLog] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ValidationLog.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
