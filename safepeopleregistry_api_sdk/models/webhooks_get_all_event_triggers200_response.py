...
class WebhooksGetAllEventTriggers200Response(BaseModel):
    """
    WebhooksGetAllEventTriggers200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["success"]})
    data: Optional[List[WebhooksGetAllEventTriggers200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [WebhooksGetAllEventTriggers200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
